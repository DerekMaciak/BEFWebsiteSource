...
if ( ! function_exists( 'optionsframework_page_notice' ) ) {
    ...
    function optionsframework_page_notice() {
		...
		$plugin_url = network_admin_url( 'plugin-install.php?tab=plugin-information&plugin=options-framework&TB_iframe=true&width=700&height=450' );
...
TEXT;
		...
		$defaults['footer_copyright']					= 'Copyright [copyright_symbol] [current_year] [site_name]. Powered by <a href="http://churchthemes.com" rel="nofollow">churchthemes.com</a>.';
