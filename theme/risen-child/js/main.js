...
jQuery(document).ready(function($) {
	...
	if (!bad_ie) {
	    ...
	    // BEF - Custom jQuery to Activate Menu based on URL - This js code adds the "active" class to menu items and their parents whose href looks like the browser's current url
		var currentPage = window.location.pathname;

		if (currentPage != '/') {
		    $("#header-menu-links a[href$='" + currentPage + "']").each(function () {
